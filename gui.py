...
class Ui :
    ...
    def __init__(self):
        ...
        self.buildGraphButton.grid(row=8, column=0, padx=10, pady=5, columnspan=2)
        ...
        self.visualizeGraphButton.grid(row=9, column=0, padx=10, pady=5, columnspan=2)
        ...
        self.searchPostsButton.grid(row=10, column=0, padx=10, pady=5, columnspan=2)

        # Add an entry widget for the topic
        self.topicEntry = ct.CTkEntry(self.frame_buttons, width=100)
        self.topicEntry.grid(row=11, column=0, padx=10, pady=5, columnspan=2)
        ...
        self.networkAnalysisButton.grid(row=12, column=0, padx=10, pady=5, columnspan=2)

        # Add entry widgets for user IDs
        self.user1Entry = ct.CTkEntry(self.frame_buttons, width=50)
        self.user1Entry.grid(row=13, column=1, padx=10, pady=5)
        self.user1ID = ct.CTkLabel(self.frame_buttons, text ="User1 ID:", padx = 5, pady = 5)
        self.user1ID.grid(row=13, column=0, padx=10, pady=5)

        self.user2Entry = ct.CTkEntry(self.frame_buttons, width=50)
        self.user2Entry.grid(row=14, column=1, padx=10, pady=5)
        self.user2ID = ct.CTkLabel(self.frame_buttons, text ="User2 ID:", padx = 5, pady = 5)
        self.user2ID.grid(row=14, column=0, padx=10, pady=5)
        ...
        self.undo_button.grid(row=15, column=0, padx=5, pady=5)
        self.redo_button = ct.CTkButton(self.frame_buttons, width=50, text="Redo", command=self.redo)
        self.redo_button.grid(row=15, column=1, padx=5, pady=5)
